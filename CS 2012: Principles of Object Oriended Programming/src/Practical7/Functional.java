...
public class Functional extends Data {
	...
	public Functional(Column col,String tcolumn,String value) {
                 super(tcolumn,col);
		 data = value;
	}
	...
	public String getOutput() {
		...
		double answer = 0.0;
			...
			operand2 = newdata.substring(newdata.indexOf(",")+1,newdata.length());
                            try{
                            operand1 = super.getColumn().getCell(operand1).toString();
                        	}
                            catch(Exception e){}
                            try{
                            operand2 = super.getColumn().getCell(operand2).toString();
                        	}
                            catch(Exception e){}
                            return operand1 + operand2;
                        }
		else{
                        return super.getColumn().getCell(newdata).toString();
                     }
		...
		try{
			...
			num1 = Double.parseDouble(super.getColumn().getCell(operand1).toString());
		}
		...
		try{
			...
			num2 =  Double.parseDouble(super.getColumn().getCell(operand2).toString());
		}
