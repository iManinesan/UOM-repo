/* File:     linked_list_mutex.c
 *
 * Purpose:  Implement a multi-threaded sorted linked list of 
 *           ints with operations insert, member, delete.
 *           This version uses mutex   
 * 
 * Compile:  gcc -g -Wall -o linked_list_mutex linked_list_mutex.c -lm -lpthread
 * Run: ./linked_list_mutex <no-of-elements> <no-of-operations> <fraction-of-member> <fraction-of-insert> <fraction-of-delete> <no-of-threads>
 */
