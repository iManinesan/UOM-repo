...
namespace Assasins
{
    class Client
    {
        ...
        private void load()
        {
            ...
            msg("Client Started");
            listener = new TcpListener(IPAddress.Parse("10.10.62.124"), 7000);
        ...
        public void connect()
        {
            try
            {
               // clientSocket.Connect("10.8.106.49", 6000);
                clientSocket.Connect("10.8.106.49", 6000);
            }
            catch (Exception e)
            {
                Console.WriteLine("connect error\t" + e.Message.ToString());
            }
        ...
        public void send(String message)
        {
            ...
            if (clientSocket.Connected)
            {
                ...
                {
                    Console.WriteLine("send error\t" + e.Message.ToString());
                }
